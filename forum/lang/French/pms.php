...
// View a message
'View'					=>	'Voir une discussion privée',
'Reply'					=>	'Répondre',
'Quote'					=>	'Citer',
...
'Send to'				=>	'Envoyer à',
'Send multiple'			=>	'Vous pouvez envoyer le message à plusieurs destinataires en les séparant par des virgules. Maximum : ',
...
'Others'				=>	'Autres',
'RE'					=>	'RE: ',
'Shared message'		=>	'Si vous avez mis plus d\'un destinataire, cochez cette case si vous voulez démarrer une conversation privée ensemble',
...
'Topic warning info'	=>	'Le sujet disparaîtra de votre boîte de réception mais restera dans celle des autres participants.',
'Delete for everybody'	=>	'Si vous cochez cette case, vous supprimerez la discussion (ou le message) pour tous les participants (option disponible seulement pour les admins et modos).',
