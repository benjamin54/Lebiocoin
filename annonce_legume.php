...
<div id="menu">
		<ul>
          ...
          --><li class="menu1"><a href="annonce_legume.php">ANNONCE LEGUMES</li><!--
          --><li class="menu1"><a href="annonce_fruit.php">ANNONCE FRUITS</a></li><!--
...
$reponse = $base->query('SELECT * FROM annonce WHERE region = \'region\' ORDER BY date_ajout DESC'); //annonces triées par date la plus récente
